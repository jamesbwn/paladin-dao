...
export class PalStaking__epochResult {
  value0: BigInt;
  value1: BigInt;
  value2: BigInt;
  value3: BigInt;
...
export class PalStaking__warmupInfoResult {
  value0: BigInt;
  value1: BigInt;
  value2: BigInt;
  value3: boolean;
...
export class PalStaking extends ethereum.SmartContract {
  static bind(address: Address): PalStaking {
    return new PalStaking("PalStaking", address);
  }
  ...
  epoch(): PalStaking__epochResult {
    ...
    return new PalStaking__epochResult(
      result[0].toBigInt(),
      result[1].toBigInt(),
      result[2].toBigInt(),
      result[3].toBigInt()
  ...
  try_epoch(): ethereum.CallResult<PalStaking__epochResult> {
    let result = super.tryCall(
      "epoch",
      "epoch():(uint256,uint256,uint256,uint256)",
      []
  ...
  sPAL(): Address {
    let result = super.call("sPAL", "sPAL():(address)", []);

    return result[0].toAddress();
  }

  try_sPAL(): ethereum.CallResult<Address> {
    let result = super.tryCall("sPAL", "sPAL():(address)", []);
    if (result.reverted) {
      return new ethereum.CallResult();
    }
    let value = result.value;
  ...
  warmupInfo(param0: Address): PalStaking__warmupInfoResult {
    let result = super.call(
      "warmupInfo",
    ...
    return new PalStaking__warmupInfoResult(
      result[0].toBigInt(),
      result[1].toBigInt(),
      result[2].toBigInt(),
      result[3].toBoolean()
  ...
  try_warmupInfo(
    param0: Address
  ): ethereum.CallResult<PalStaking__warmupInfoResult> {
    let result = super.tryCall(
      "warmupInfo",
      "warmupInfo(address):(uint256,uint256,uint256,bool)",
      [ethereum.Value.fromAddress(param0)]
    ...
    let value = result.value;
    return ethereum.CallResult.fromValue(
      new PalStaking__warmupInfoResult(
        value[0].toBigInt(),
        value[1].toBigInt(),
        value[2].toBigInt(),
        value[3].toBoolean()
