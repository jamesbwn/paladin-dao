...
import {PALADIN_ERC20_CONTRACT, SPALADIN_ERC20_CONTRACT_V1, STAKING_CONTRACT_V1} from './utils/Constants'
...
export function rebaseFunction(event: LogRebase): void {
    ...
    if (rebase == null && event.params.rebase.gt(BigInt.fromI32(0))) {
        ...
        let spal_contract = sPalERC20.bind(Address.fromString(SPALADIN_ERC20_CONTRACT_V1))
