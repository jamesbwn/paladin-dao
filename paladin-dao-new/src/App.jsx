...
import { Convert, Stake, ChooseBond, Bond, TreasuryDashboard, PoolTogether, Portfolio, NftMint, NftStake } from "./views";
...
function App() {
  ...
  useEffect(() => {
    ...
    if (shouldTriggerSafetyCheck()) {
      dispatch(info("Safety Check: Always verify you're on paladin-dao.netlify.app!"));
    }
  }, []);
