...
import { abi as DaiBond44Contract } from "src/abi/bonds/BusdContract44.json";
...
export class LPBond extends Bond {
  ...
  async getTreasuryBalance(networkID: NetworkID, provider: StaticJsonRpcProvider) {
    ...
    if (this.fourAddress) {
      const fourBond = new ethers.Contract(this.fourAddress, DaiBond44Contract, provider);
