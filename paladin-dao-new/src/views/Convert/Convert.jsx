                      ...
                      <div className="data-display">
                        {
                          ...
                          // )
                          <Typography variant="h5"> Convert Presale Tokens to Public Tokens 🔥</Typography>
                        }
                      </div>
                    </div>
                  </Grid>
                  <div className="staking-area">
                    {!address ? (
                      <div className="stake-wallet-notification">
                        ...
                        <Typography variant="h6">Connect your wallet to convert PAL token</Typography>
                      </div>
                    ) : (
                      <>
                          ...
                          <Box className="stake-action-row " display="flex" alignItems="center">
                                ...
                                <Box className="help-text">
                                  <Typography variant="body1" className="stake-note" color="textSecondary">
                                    <>
                                      ...
                                      <br />
                                      Please approve Paladin DAO to use your <b>PD</b> to convert PAL
                                    </>
                                  </Typography>
                                </Box>
                              ) : (
                            ...
                            <TabPanel value={view} index={0} className="stake-tab-panel">
                              {isAllowanceDataLoading ? (
                                ...
                                >
                                  {txnButtonText(pendingTransactions, "converting", "Convert PAL")}
                                </Button>
                              ) : (
                                <Button
                                  className="stake-button"
                        ...
                        <div className={`stake-user-data`}>
                          ...
                          <div className="data-row">
                            <Typography variant="body1">Your Paladin Token Balance</Typography>
                            <Typography variant="body1">
