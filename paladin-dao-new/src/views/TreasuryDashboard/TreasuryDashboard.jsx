  ...
  useEffect(() => {
    apollo(treasuryDataQuery).then(r => {
      ...
      let staked = r?.data?.protocolMetrics.map(entry => ({
        staked: (parseFloat(entry.sPalCirculatingSupply) / parseFloat(entry.palCirculatingSupply)) * 100,
            ...
            <Grid item lg={6} md={6} sm={12} xs={12}>
              <Paper className="ohm-card ohm-chart-card">
                <Chart
                  ...
                  data={data}
                  format="currency"
                  dataKey={["treasuryBUSDRiskFreeValue", "treasuryRiskFreeValue"]}
                  stopColor={[
                    ["#F5AC37", "#EA9276"],
                    ["#768299", "#98B3E9"],
                    ["#000", "#fff"],
            ...
            <Grid item lg={6} md={6} sm={12} xs={12}>
              <Paper className="ohm-card">
                <Chart
                  type="area"
                  data={data}
                  dataKey={["treasuryPalBusdPOL"]}
                  stopColor={[["rgba(128, 204, 131, 1)", "rgba(128, 204, 131, 0)"]]}
                  headerText="Protocol Owned Liquidity PAL-DAI"
                  headerSubText={`${data && trim(data[0].treasuryPalBusdPOL, 2)}% `}
                  dataFormat="percent"
