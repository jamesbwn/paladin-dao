...
function NftMint() {
  ...
  const isWhite = useSelector(state => {
    return state.nftMint.whiteListed;
  });
          ...
          <Paper className={`ohm-card`}>
            ...
            <div className={`nftmint-user-data`}>
              <div className="data-row">
                <Typography variant="body1">White Listed</Typography>
                <Typography variant="body1">
                  {isAppLoading ? <Skeleton width="80px" /> : <>{isWhite == true ? "Yes" : "No"} </>}
                </Typography>
              </div>
              <div className="data-row">
              ...
              <div className="data-row">
                ...
                <Typography variant="body1">
                  {isAppLoading ? <Skeleton width="80px" /> : <>{trim(nftBalance, 4)} TPNM</>}
                </Typography>
              </div>
            </div>
          </Paper>
