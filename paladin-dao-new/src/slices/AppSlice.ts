...
export const loadAppDetails = createAsyncThunk(
  ...
  async ({ networkID, provider }: IBaseAsyncThunk, { dispatch }) => {
    ...
    const INFURA_END_POINT = "https://mainnet.infura.io/v3/5c6652c286654b7e94e0eebf0cd5afa3"
    ...
    // console.log('debug staking reward, rebase, five, apy', stakingReward, stakingRebase, fiveDayRate, stakingAPY)
    return {
